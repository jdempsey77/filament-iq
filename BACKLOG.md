...
### Low Priority
- [x] Label printer format mismatch — label_printer.py generates 236x236 Fixed: restored rectangular DK-1201 29x90mm format, 991x306 landscape canvas, rotate=-90 to portrait. Verified dry_run label=29x90 success=True. (2026-05-06) PR #69 restored from original working commit 197754c after color regression in PR #67.
