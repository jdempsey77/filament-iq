...
if [[ "$MODE" == "pre" ]]; then
  ...
  BOOLEANS=(input_boolean.p1s_nonrfid_enabled input_boolean.p1s_print_active input_boolean.p1s_needs_reconcile input_boolean.p1s_debug_finish_trigger input_boolean.appdaemon_startup_suppress_swap input_boolean.filament_debug_mode)
  TEXTS=(input_text.p1s_trays_used_this_print input_text.p1s_last_mapping_json input_text.p1s_start_json input_text.p1s_end_json input_text.p1s_active_job_key input_text.bambu_printer_access_code input_text.spoolman_base_url)
  ...
  BOOLEANS=(input_boolean.filament_iq_nonrfid_enabled input_boolean.filament_iq_print_active input_boolean.filament_iq_needs_reconcile input_boolean.filament_iq_debug_finish_trigger input_boolean.filament_iq_startup_suppress_swap input_boolean.filament_iq_debug_mode)
  TEXTS=(input_text.filament_iq_trays_used_this_print input_text.filament_iq_last_mapping_json input_text.filament_iq_start_json input_text.filament_iq_end_json input_text.filament_iq_active_job_key input_text.bambu_printer_access_code input_text.spoolman_base_url)
